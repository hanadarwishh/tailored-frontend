...
import { FiCopy, FiEdit, FiUpload, FiSend } from "react-icons/fi";
  ...
  const sendMessageToServer = async (message, uploadedFile = null) => {
    try {
      ...
      const response = await axios.post(
        "http://localhost:3006/api/chatbot/multi-purpose/upload",
        formData,
        {
  ...
  return (
    <div className="chatbot-chat-container">
      ...
      <div className="chatbot-input-area">
        <label htmlFor="file-upload" className="chatbot-upload-btn">
          <FiUpload />
        </label>
        <input
          type="file"
